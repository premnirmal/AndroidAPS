...
class SearchIndexBuilder(
     ...
     * plugin is list-visible. VirtualPump on a client is hidden, so its settings stay out of search —
     * the values come from the master and are not editable locally.
     */
