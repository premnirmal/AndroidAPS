...
dependencies {
    ...
    // Garmin
    add("api", libs.com.garmin.connectiq) { artifact { type = "aar" } }
    add("androidTestImplementation", libs.com.garmin.connectiq) { artifact { type = "aar" } }

    add("implementation", libs.com.google.dagger.hilt.android)
    ...
    add("implementation", libs.androidx.health.connect.client)

    add("ksp", libs.com.google.dagger.compiler)
    add("ksp", libs.com.google.dagger.hilt.compiler)
    add("ksp", libs.com.google.dagger.android.processor)
