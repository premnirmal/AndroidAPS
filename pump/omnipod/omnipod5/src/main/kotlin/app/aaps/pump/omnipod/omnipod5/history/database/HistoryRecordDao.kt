...
abstract class HistoryRecordDao {
    ...
    @Query("SELECT * FROM historyrecords ORDER BY createdAt DESC")
    ...
    abstract fun save(record: HistoryRecordEntity): Single<Long>

    @Delete
    abstract fun delete(record: HistoryRecordEntity): Completable
